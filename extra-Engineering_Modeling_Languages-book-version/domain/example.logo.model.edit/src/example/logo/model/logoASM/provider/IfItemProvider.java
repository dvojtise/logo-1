...
/**
 * This is the item provider adapter for a {@link example.logo.model.logoASM.If} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfItemProvider extends ControlStructureItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LogoASMPackage.Literals.IF__THEN_PART);
			childrenFeatures.add(LogoASMPackage.Literals.IF__ELSE_PART);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LogoASMPackage.Literals.IF__THEN_PART,
				 LogoASMFactory.eINSTANCE.createBlock()));

		newChildDescriptors.add
			(createChildParameter
				(LogoASMPackage.Literals.IF__ELSE_PART,
				 LogoASMFactory.eINSTANCE.createBlock()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == LogoASMPackage.Literals.IF__THEN_PART ||
			childFeature == LogoASMPackage.Literals.IF__ELSE_PART;
