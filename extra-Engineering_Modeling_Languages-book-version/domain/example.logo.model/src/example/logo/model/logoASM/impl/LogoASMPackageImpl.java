/**
 */
package example.logo.model.logoASM.impl;
...
import example.logo.model.logoASM.util.LogoASMValidator;
...
public class LogoASMPackageImpl extends EPackageImpl implements LogoASMPackage {
	 ...
	 * @see example.logo.model.logoASM.LogoASMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
			...
			(theLogoASMPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return LogoASMValidator.INSTANCE;
				 }
			 });
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (procCallEClass, 
		   source, 
		   new String[] {
			 "constraints", "same_number_of_formals_and_actuals"
		   });	
		addAnnotation
		  (procDeclarationEClass, 
		   source, 
		   new String[] {
			 "constraints", "unique_names_for_formal_arguments"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (procCallEClass, 
		   source, 
		   new String[] {
			 "same_number_of_formals_and_actuals", "actualArgs->size() = declaration.args->size()"
		   });	
		addAnnotation
		  (procDeclarationEClass, 
		   source, 
