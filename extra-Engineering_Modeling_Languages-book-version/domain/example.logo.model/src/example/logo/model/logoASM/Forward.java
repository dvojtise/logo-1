 ...
 * <ul>
 *   <li>{@link example.logo.model.logoASM.Forward#getSteps <em>Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @see example.logo.model.logoASM.LogoASMPackage#getForward()
 * @model
 * @generated
 */
public interface Forward extends Primitive {
	 ...
	 * @see example.logo.model.logoASM.LogoASMPackage#getForward_Steps()
	...
	/**
	 * Sets the value of the '{@link example.logo.model.logoASM.Forward#getSteps <em>Steps</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
