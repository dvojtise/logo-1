...
public class LogoTextualSyntaxParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected example.logo.xtext_editor.parser.antlr.internal.InternalLogoTextualSyntaxParser createParser(XtextTokenStream stream) {
		return new example.logo.xtext_editor.parser.antlr.internal.InternalLogoTextualSyntaxParser(stream, getGrammarAccess());
	}
