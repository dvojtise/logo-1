 ...
 * generated by Xtext
 */
package example.logo.xtext_editor.services;
...
public class LogoTextualSyntaxGrammarAccess extends AbstractGrammarElementFinder {
	...
	private final BInstructionElements pBInstruction;
	...
	public LogoTextualSyntaxGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pBInstruction = new BInstructionElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("example.logo.xtext_editor.LogoTextualSyntax".equals(grammar.getName())) {
				return grammar;
			}
