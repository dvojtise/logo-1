...
* generated by Xtext
*/
package fr.inria.diverse.k3.example.logo.xtext_editor.services;
...
public class LogoTextualSyntaxGrammarAccess extends AbstractGrammarElementFinder {
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("fr.inria.diverse.k3.example.logo.xtext_editor.LogoTextualSyntax".equals(grammar.getName())) {
				return grammar;
			}
