 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.sed.logo.impl.LeftImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LeftImpl extends InstructionImpl implements Left {
	...
	public NotificationChain basicSetAngle(Expression newAngle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoPackage.LEFT__ANGLE,
					oldAngle, newAngle);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAngle(Expression newAngle) {
		if (newAngle != angle) {
			...
			if (angle != null)
				msgs = ((InternalEObject) angle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoPackage.LEFT__ANGLE,
						null, msgs);
			if (newAngle != null)
				msgs = ((InternalEObject) newAngle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoPackage.LEFT__ANGLE,
						null, msgs);
