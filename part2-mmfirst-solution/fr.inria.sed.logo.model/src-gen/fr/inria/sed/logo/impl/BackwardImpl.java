 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.sed.logo.impl.BackwardImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BackwardImpl extends PrimitiveInstructionImpl implements Backward {
	...
	protected EClass eStaticClass() {
		return LogoPackage.Literals.BACKWARD;
	}
	...
	public NotificationChain basicSetSteps(Expression newSteps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoPackage.BACKWARD__STEPS,
					oldSteps, newSteps);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSteps != steps) {
			...
			if (steps != null)
				msgs = ((InternalEObject) steps).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LogoPackage.BACKWARD__STEPS, null, msgs);
			if (newSteps != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LogoPackage.BACKWARD__STEPS, newSteps, newSteps));
	}
