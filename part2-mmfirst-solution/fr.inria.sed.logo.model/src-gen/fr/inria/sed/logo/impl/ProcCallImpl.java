 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.sed.logo.impl.ProcCallImpl#getDeclaration <em>Declaration</em>}</li>
 *   <li>{@link fr.inria.sed.logo.impl.ProcCallImpl#getActualArgs <em>Actual Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcCallImpl extends PrimitiveInstructionImpl implements ProcCall {
		...
		if (declaration != null && declaration.eIsProxy()) {
			...
			if (declaration != oldDeclaration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogoPackage.PROC_CALL__DECLARATION,
	...
	public void setDeclaration(ProcDeclaration newDeclaration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogoPackage.PROC_CALL__DECLARATION, oldDeclaration,
					declaration));
	}
	...
	public EList<Expression> getActualArgs() {
		if (actualArgs == null) {
			actualArgs = new EObjectContainmentEList<Expression>(Expression.class, this,
					LogoPackage.PROC_CALL__ACTUAL_ARGS);
		}
		return actualArgs;
	}
