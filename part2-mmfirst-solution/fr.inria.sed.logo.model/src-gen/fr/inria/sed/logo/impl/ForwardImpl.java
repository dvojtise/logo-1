 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.sed.logo.impl.ForwardImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForwardImpl extends InstructionImpl implements Forward {
	...
	public NotificationChain basicSetSteps(Expression newSteps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoPackage.FORWARD__STEPS,
					oldSteps, newSteps);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSteps != steps) {
			...
			if (steps != null)
				msgs = ((InternalEObject) steps).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LogoPackage.FORWARD__STEPS, null, msgs);
			if (newSteps != null)
