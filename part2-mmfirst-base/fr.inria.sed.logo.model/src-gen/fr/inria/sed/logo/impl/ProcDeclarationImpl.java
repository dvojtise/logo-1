 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.sed.logo.impl.ProcDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.inria.sed.logo.impl.ProcDeclarationImpl#getArgs <em>Args</em>}</li>
 *   <li>{@link fr.inria.sed.logo.impl.ProcDeclarationImpl#getInstructions <em>Instructions</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public EList<Instruction> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentEList<Instruction>(Instruction.class, this,
					LogoPackage.PROC_DECLARATION__INSTRUCTIONS);
		}
		return instructions;
	}
