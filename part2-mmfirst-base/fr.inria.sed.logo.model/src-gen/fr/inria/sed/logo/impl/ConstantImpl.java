 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.sed.logo.impl.ConstantImpl#getIntegerValue <em>Integer Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstantImpl extends ExpressionImpl implements Constant {
	...
	protected EClass eStaticClass() {
		return LogoPackage.Literals.CONSTANT;
	}
	...
	public void setIntegerValue(int newIntegerValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogoPackage.CONSTANT__INTEGER_VALUE, oldIntegerValue,
					integerValue));
	}
