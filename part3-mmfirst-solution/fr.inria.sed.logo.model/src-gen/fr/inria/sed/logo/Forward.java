 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.sed.logo.Forward#getSteps <em>Steps</em>}</li>
 * </ul>
 *
 * @see fr.inria.sed.logo.LogoPackage#getForward()
 * @model
 * @generated
 */
public interface Forward extends PrimitiveInstruction {
	/**
	 ...
	 * @see fr.inria.sed.logo.LogoPackage#getForward_Steps()
	...
	/**
	 * Sets the value of the '{@link fr.inria.sed.logo.Forward#getSteps <em>Steps</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
