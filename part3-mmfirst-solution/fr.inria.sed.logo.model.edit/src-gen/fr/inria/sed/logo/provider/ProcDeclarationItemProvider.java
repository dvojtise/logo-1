...
/**
 * This is the item provider adapter for a {@link fr.inria.sed.logo.ProcDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcDeclarationItemProvider extends InstructionItemProvider {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProcDeclaration_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ProcDeclaration_name_feature",
								"_UI_ProcDeclaration_type"),
						LogoPackage.Literals.PROC_DECLARATION__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LogoPackage.Literals.PROC_DECLARATION__ARGS);
			childrenFeatures.add(LogoPackage.Literals.PROC_DECLARATION__INSTRUCTIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcDeclaration.png"));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(LogoPackage.Literals.PROC_DECLARATION__ARGS,
				LogoFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add(createChildParameter(LogoPackage.Literals.PROC_DECLARATION__INSTRUCTIONS,
