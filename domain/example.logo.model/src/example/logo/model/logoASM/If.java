 ...
 * <ul>
 *   <li>{@link example.logo.model.logoASM.If#getThenPart <em>Then Part</em>}</li>
 *   <li>{@link example.logo.model.logoASM.If#getElsePart <em>Else Part</em>}</li>
 * </ul>
 * </p>
 *
 * @see example.logo.model.logoASM.LogoASMPackage#getIf()
 * @model
 * @generated
 */
public interface If extends ControlStructure {
	 ...
	 * @see example.logo.model.logoASM.LogoASMPackage#getIf_ThenPart()
	...
	/**
	 * Sets the value of the '{@link example.logo.model.logoASM.If#getThenPart <em>Then Part</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see example.logo.model.logoASM.LogoASMPackage#getIf_ElsePart()
	...
	/**
	 * Sets the value of the '{@link example.logo.model.logoASM.If#getElsePart <em>Else Part</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
