 ...
 * <ul>
 *   <li>{@link example.logo.model.logoASM.Left#getAngle <em>Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @see example.logo.model.logoASM.LogoASMPackage#getLeft()
 * @model
 * @generated
 */
public interface Left extends Primitive {
	 ...
	 * @see example.logo.model.logoASM.LogoASMPackage#getLeft_Angle()
	...
	/**
	 * Sets the value of the '{@link example.logo.model.logoASM.Left#getAngle <em>Angle</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
