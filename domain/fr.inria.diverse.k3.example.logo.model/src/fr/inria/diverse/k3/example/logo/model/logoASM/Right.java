 ...
 * <ul>
 *   <li>{@link fr.inria.diverse.k3.example.logo.model.logoASM.Right#getAngle <em>Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.diverse.k3.example.logo.model.logoASM.LogoASMPackage#getRight()
 * @model
 * @generated
 */
public interface Right extends Primitive {
	 ...
	 * @see fr.inria.diverse.k3.example.logo.model.logoASM.LogoASMPackage#getRight_Angle()
	...
	/**
	 * Sets the value of the '{@link fr.inria.diverse.k3.example.logo.model.logoASM.Right#getAngle <em>Angle</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
